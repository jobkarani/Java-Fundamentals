// Calc engine with Date Arithmetics support
// running the code on the terminal/commandline use e.g: *** java CalcEngineDateMaths.java interactive *** // when 2022-12-25 seven //  

package dateAndTime;
import java.time.LocalDate;
import java.util.Scanner;

public class CalcEngineDateMaths{
